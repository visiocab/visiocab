...
// Pano2VR pro 4.5beta/10252
// Filename: AASFv1-otherscenes.ggsk
// Generated Mon Jan 20 14:18:05 2014
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._toolbarbg.className='ggskin ggskin_image';
		...
		this._toolbarbg__img.className='ggskin ggskin_image';
		this._toolbarbg__img.setAttribute('src',basePath + 'images/toolbarbg.png');
		this._toolbarbg__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._toolbarbg__img.className='ggskin ggskin_image';
		this._toolbarbg__img['ondragstart']=function() { return false; };
		...
		this._zoomoutbutton.className='ggskin ggskin_image';
		hs ='position:absolute;';
		hs+='left: 68px;';
		hs+='top:  5px;';
		hs+='width: 31px;';
		...
		this._zoomoutbutton__img.className='ggskin ggskin_image';
		this._zoomoutbutton__img.setAttribute('src',basePath + 'images/zoomoutbutton.png');
		this._zoomoutbutton__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._zoomoutbutton__img.className='ggskin ggskin_image';
		this._zoomoutbutton__img['ondragstart']=function() { return false; };
		...
		this._zoominbutton.className='ggskin ggskin_image';
		hs ='position:absolute;';
		hs+='left: 25px;';
		hs+='top:  5px;';
		hs+='width: 31px;';
		...
		this._zoominbutton__img.className='ggskin ggskin_image';
		this._zoominbutton__img.setAttribute('src',basePath + 'images/zoominbutton.png');
		this._zoominbutton__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
		this._zoominbutton__img.className='ggskin ggskin_image';
		this._zoominbutton__img['ondragstart']=function() { return false; };
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='Up01') {
			this.__div=document.createElement('div');
			this.__div.ggId="Up01";
			...
			this._up.className='ggskin ggskin_image';
			hs ='position:absolute;';
			hs+='left: -49px;';
			hs+='top:  -36px;';
			hs+='width: 80px;';
			...
			this._up__img.className='ggskin ggskin_image';
			...
			this._up.onclick=function () {
				me.player.openUrl("\/tours\/?s=01","_parent");
			}
			this.__div.appendChild(this._up);
		} else
		{
			this.__div=document.createElement('div');
			this.__div.ggId="Up02";
			this.__div.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this.__div.ggVisible=true;
			this.__div.className='ggskin ggskin_hotspot';
			hs ='position:absolute;';
			...
			this._up020__img.className='ggskin ggskin_image';
			this._up020__img.setAttribute('src',basePath + 'images/up020.png');
			this._up020__img.setAttribute('style','position: absolute;top: 0px;left: 0px;-webkit-user-drag:none;');
			this._up020__img.className='ggskin ggskin_image';
			this._up020__img['ondragstart']=function() { return false; };
			me.player.checkLoaded.push(this._up020__img);
			this._up020.appendChild(this._up020__img);
			this._up020.onclick=function () {
