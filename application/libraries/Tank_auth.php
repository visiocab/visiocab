...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $first_name, $last_name, $role, $email_activation)
	{
		error_log("submitted values: $username, $email, $password, $first_name, $last_name, $role, $email_activation ");
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			if (!is_null($res = $this->ci->users->create_user($data, $role, !$email_activation))) {
